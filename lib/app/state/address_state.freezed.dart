...
mixin _$AddressState {
  List<Address>? get addressModel => throw _privateConstructorUsedError;
...
abstract class $AddressStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Address>? addressModel, bool isLoading});
}
...
class _$AddressStateImpl implements _AddressState {
  const _$AddressStateImpl(
      {final List<Address>? addressModel, this.isLoading = false})
      : _addressModel = addressModel;

  final List<Address>? _addressModel;
  @override
  List<Address>? get addressModel {
    final value = _addressModel;
    if (value == null) return null;
    if (_addressModel is EqualUnmodifiableListView) return _addressModel;
  ...
  @override
  String toString() {
    return 'AddressState(addressModel: $addressModel, isLoading: $isLoading)';
  }
  ...
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(_addressModel), isLoading);
...
abstract class _AddressState implements AddressState {
  const factory _AddressState(
      {final List<Address>? addressModel,
